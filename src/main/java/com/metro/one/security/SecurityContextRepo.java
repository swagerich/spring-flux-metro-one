package com.metro.one.security;

import com.metro.one.security.jwt.JwtAuthenticationManager;
...
public class SecurityContextRepo implements ServerSecurityContextRepository {
    ...
    public SecurityContextRepo(JwtAuthenticationManager jwtAuthenticationManager) {
